...
var _user$project$Main$filterChoiceView = F3(
...
var _user$project$Main$filterView = F4(
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							function (filter) {
								return A3(_user$project$Main$filterChoiceView, filter, currentFilters, action);
							},
							possibleFilters)),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$dayEventInstanceView = function (eventInstance) {
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							A3(_elm_lang$core$String$slice, 11, 16, eventInstance.from),
							A2(
								_elm_lang$core$Basics_ops['++'],
								' - ',
								A3(_elm_lang$core$String$slice, 11, 16, eventInstance.to)))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$dayRowView = F2(
	function (day, model) {
		var locations = A2(
			_elm_lang$core$List$map,
		...
		var filteredEventInstances = A2(
			...
			function (eventInstance) {
				return _elm_lang$core$Native_Utils.eq(
					A3(_elm_lang$core$String$slice, 0, 10, eventInstance.from),
					day.iso) && (A2(_elm_lang$core$List$member, eventInstance.location, locations) && A2(_elm_lang$core$List$member, eventInstance.eventType, types));
			},
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A2(_elm_lang$core$List$map, _user$project$Main$dayEventInstanceView, filteredEventInstances)),
					_1: {ctor: '[]'}
				}
			});
	});
var _user$project$Main$scheduleServer = 'ws://localhost:8000/schedule/';
var _user$project$Main$sendInitMessage = function (camp_slug) {
	return A2(
		_elm_lang$websocket$WebSocket$send,
		_user$project$Main$scheduleServer,
		A2(
...
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {days: a, eventInstances: b, eventLocations: c, eventTypes: d, flags: e, activeDay: f, filter: g};
	});
var _user$project$Main$Filter = F2(
	function (a, b) {
		return {eventTypes: a, eventLocations: b};
	});
var _user$project$Main$Day = F3(
	function (a, b, c) {
		return {day_name: a, iso: b, repr: c};
	});
var _user$project$Main$allDaysDay = A3(_user$project$Main$Day, 'All Days', '', '');
var _user$project$Main$init = function (flags) {
	return {
		...
		_0: A7(
			...
			{ctor: '[]'},
			flags,
			_user$project$Main$allDaysDay,
			A2(
				_user$project$Main$Filter,
				{ctor: '[]'},
				{ctor: '[]'})),
		_1: _user$project$Main$sendInitMessage(flags.camp_slug)
	};
};
var _user$project$Main$dayDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'day_name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Day))));
var _user$project$Main$Speaker = F2(
	function (a, b) {
		return {name: a, url: b};
	});
var _user$project$Main$speakerDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'url',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'name',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Speaker)));
var _user$project$Main$EventInstance = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {title: a, id: b, url: c, $abstract: d, eventSlug: e, eventType: f, backgroundColor: g, forgroundColor: h, from: i, to: j, timeslots: k, location: l, locationIcon: m, speakers: n, videoRecording: o, videoUrl: p};
															};
														};
													};
												};
...
var _user$project$Main$eventInstanceDecoder = A4(
	...
	A3(
		...
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'speakers',
			_elm_lang$core$Json_Decode$list(_user$project$Main$speakerDecoder),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'location_icon',
				_elm_lang$core$Json_Decode$string,
													...
													A3(
														...
														A3(
															...
															A3(
																...
																'title',
																_elm_lang$core$Json_Decode$string,
																_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$EventInstance)))))))))))))))));
var _user$project$Main$EventLocation = F3(
	function (a, b, c) {
		return {name: a, slug: b, icon: c};
	});
var _user$project$Main$eventLocationDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'icon',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$EventLocation))));
var _user$project$Main$EventType = F4(
	function (a, b, c, d) {
		return {name: a, slug: b, color: c, lightText: d};
	});
var _user$project$Main$eventTypeDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'light_text',
	_elm_lang$core$Json_Decode$bool,
	A3(
		...
		A3(
			...
			A3(
				...
				'name',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$EventType)))));
var _user$project$Main$initDataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'event_types',
	_elm_lang$core$Json_Decode$list(_user$project$Main$eventTypeDecoder),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'event_locations',
		_elm_lang$core$Json_Decode$list(_user$project$Main$eventLocationDecoder),
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'event_instances',
			_elm_lang$core$Json_Decode$list(_user$project$Main$eventInstanceDecoder),
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'days',
				_elm_lang$core$Json_Decode$list(_user$project$Main$dayDecoder),
		...
		switch (_p0.ctor) {
			...
			case 'WebSocketPayload':
				var newModel = function () {
					var _p1 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Main$initDataDecoder, _p0._0);
					if (_p1.ctor === 'Ok') {
						return A3(
							_p1._0,
							model.flags,
			...
			case 'ToggleEventTypeFilter':
				...
				var eventTypesFilter = A2(_elm_lang$core$List$member, _p2, model.filter.eventTypes) ? A2(
					_elm_lang$core$List$filter,
					function (x) {
						return !_elm_lang$core$Native_Utils.eq(x, _p2);
					},
					model.filter.eventTypes) : {ctor: '::', _0: _p2, _1: model.filter.eventTypes};
			...
			default:
				var _p3 = _p0._0;
				var currentFilter = model.filter;
				var eventLocationsFilter = A2(_elm_lang$core$List$member, _p3, model.filter.eventLocations) ? A2(
					_elm_lang$core$List$filter,
					function (x) {
						return !_elm_lang$core$Native_Utils.eq(x, _p3);
					},
					model.filter.eventLocations) : {ctor: '::', _0: _p3, _1: model.filter.eventLocations};
				var newFilter = _elm_lang$core$Native_Utils.update(
					currentFilter,
...
var _user$project$Main$Flags = F4(
	function (a, b, c, d) {
		return {schedule_timeslot_length_minutes: a, schedule_midnight_offset_hours: b, ics_button_href: c, camp_slug: d};
	});
var _user$project$Main$ToggleEventLocationFilter = function (a) {
	return {ctor: 'ToggleEventLocationFilter', _0: a};
};
var _user$project$Main$ToggleEventTypeFilter = function (a) {
	return {ctor: 'ToggleEventTypeFilter', _0: a};
};
var _user$project$Main$MakeActiveday = function (a) {
	return {ctor: 'MakeActiveday', _0: a};
};
var _user$project$Main$dayButton = F2(
	function (day, activeDay) {
		return A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'btn-default',
								_1: !_elm_lang$core$Native_Utils.eq(day, activeDay)
							},
							_1: {
								ctor: '::',
								_0: {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$MakeActiveday(day)),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				},
				{
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							function (day) {
								return A2(_user$project$Main$dayButton, day, model.activeDay);
							},
							{ctor: '::', _0: _user$project$Main$allDaysDay, _1: model.days})),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								},
								{
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: A4(_user$project$Main$filterView, 'Type', model.eventTypes, model.filter.eventTypes, _user$project$Main$ToggleEventTypeFilter),
												_1: {
													ctor: '::',
													_0: A4(_user$project$Main$filterView, 'Location', model.eventLocations, model.filter.eventLocations, _user$project$Main$ToggleEventLocationFilter),
													_1: {ctor: '[]'}
												}
											}),
										_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$List$map,
										function (day) {
											return A2(_user$project$Main$dayRowView, day, model);
										},
										model.days)),
								_1: {ctor: '[]'}
							}
...
var _user$project$Main$WebSocketPayload = function (a) {
	return {ctor: 'WebSocketPayload', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _user$project$Main$scheduleServer, _user$project$Main$WebSocketPayload);
};
							...
							return A2(
								...
								function (schedule_timeslot_length_minutes) {
									return _elm_lang$core$Json_Decode$succeed(
										{camp_slug: camp_slug, ics_button_href: ics_button_href, schedule_midnight_offset_hours: schedule_midnight_offset_hours, schedule_timeslot_length_minutes: schedule_timeslot_length_minutes});
								},
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"MakeActiveday":["Main.Day"],"WebSocketPayload":["String"],"ToggleEventLocationFilter":["Main.EventLocation"],"NoOp":[],"ToggleEventTypeFilter":["Main.EventType"]}}},"aliases":{"Main.Day":{"args":[],"type":"{ day_name : String, iso : String, repr : String }"},"Main.EventType":{"args":[],"type":"{ name : String, slug : String, color : String, lightText : Bool }"},"Main.EventLocation":{"args":[],"type":"{ name : String, slug : String, icon : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
