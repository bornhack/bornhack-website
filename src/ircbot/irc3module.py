...
class Plugin:
    ...
    def server_ready(self, **kwargs: dict[str, Any]) -> None:
    ...
    def connection_lost(self, **kwargs: dict[str, Any]) -> None:
        """Triggered when connection is lost"""
        logger.debug(f"inside connection_lost(), kwargs: {kwargs}")

    def connection_made(self, **kwargs: dict[str, Any]) -> None:
    ...
    def on_join_part_quit(self, **kwargs: dict[str, Any]) -> None:
    ...
    def on_join(self, mask, channel, **kwargs: dict[str, Any]) -> None:
    ...
    def on_privmsg(self, **kwargs: dict[str, Any]) -> None:
    ...
    def on_kick(self, **kwargs: dict[str, Any]) -> None:
        logger.debug(f"inside on_kick(), kwargs: {kwargs}")

    @irc3.event(irc3.rfc.MODE)
    def on_mode(self, **kwargs: dict[str, Any]) -> None:
    ...
    @irc3.extend
    def handle_chanserv_privmsg(self, **kwargs: dict[str, Any]) -> None:
    ...
    @irc3.extend
    def handle_nickserv_privmsg(self, **kwargs: dict[str, Any]) -> None:
