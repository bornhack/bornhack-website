...
def check_speaker_event_camp_consistency(sender, instance, **kwargs: dict[str, Any]) -> None:
...
def event_session_post_save(sender, instance, created, **kwargs: dict[str, Any]) -> None:
