...
urlpatterns = [
    ...
    url(r'^sponsor/$', RedirectView.as_view(url=reverse_lazy('call-for-sponsors'), permanent=True)),
    ...
    url(r'^speaker/$', RedirectView.as_view(url=reverse_lazy('call-for-speakers'), permanent=True)),
