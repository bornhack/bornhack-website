...
from teams.models import Team, TeamTask, TeamMember
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        email = EmailAddress.objects.create(
            user=user1, email="user1@example.com", primary=False, verified=True
        )
        ...
        user2.profile.save()
        email = EmailAddress.objects.create(
            user=user2, email="user2@example.com", primary=False, verified=True
        )
        email.set_as_primary()
        ...
        user3.profile.save()
        email = EmailAddress.objects.create(
            user=user3, email="user3@example.com", primary=False, verified=True
        )
        email.set_as_primary()
        ...
        user4.profile.save()
        email = EmailAddress.objects.create(
            user=user4, email="user4@example.com", primary=False, verified=True
        )
        email.set_as_primary()
        ...
        user5.profile.save()
        email = EmailAddress.objects.create(
            user=user5, email="user5@example.com", primary=False, verified=True
        )
        email.set_as_primary()
        ...
        user6.profile.save()
        email = EmailAddress.objects.create(
            user=user6, email="user6@example.com", primary=False, verified=True
        )
        email.set_as_primary()
        ...
        user7.profile.save()
        email = EmailAddress.objects.create(
            user=user7, email="user7@example.com", primary=False, verified=True
        )
        email.set_as_primary()

        user8 = User.objects.create_user(username="user8", password="user8")
        ...
        user8.profile.save()
        email = EmailAddress.objects.create(
            user=user8, email="user8@example.com", primary=False, verified=True
        )
        email.set_as_primary()

        user9 = User.objects.create_user(username="user9", password="user9")
        user9.profile.name = "John Windows"
        user9.profile.description = "Microsoft is best soft"
        user9.profile.public_credit_name = "msboy"
        user9.profile.save()
        email = EmailAddress.objects.create(
            user=user9, email="user9@example.com", primary=False, verified=True
        )
        email.set_as_primary()
        ...
        admin.profile.save()
        email = EmailAddress.objects.create(
            user=admin, email="admin@example.com", verified=True
        )
        email.set_as_primary()
        ...
        tickets = ProductCategory.objects.create(name="Tickets", slug="tickets")
        villages = ProductCategory.objects.create(name="Villages", slug="villages")
        ...
        for camp in [camp2016, camp2017, camp2018]:
            ...
            adult_one_day = TicketType.objects.create(name="Adult One Day", camp=camp)
            child_full_week = TicketType.objects.create(
                name="Child Full Week", camp=camp
            )
            child_one_day = TicketType.objects.create(name="Child One Day", camp=camp)
            ...
            order0 = Order.objects.create(
                user=user1, payment_method="cash", open=None, paid=True
            )
            order0.orderproductrelation_set.create(product=ticket1, quantity=1)
            order0.orderproductrelation_set.create(product=tent1, quantity=1)
            order0.mark_as_paid(request=None)

            order1 = Order.objects.create(user=user2, payment_method="cash", open=None)
            order1.orderproductrelation_set.create(product=ticket1, quantity=1)
            order1.orderproductrelation_set.create(product=tent2, quantity=1)
            order1.mark_as_paid(request=None)

            order2 = Order.objects.create(user=user3, payment_method="cash", open=None)
            order2.orderproductrelation_set.create(product=ticket2, quantity=1)
            order2.orderproductrelation_set.create(product=ticket1, quantity=1)
            order2.orderproductrelation_set.create(product=tent2, quantity=1)
            order2.mark_as_paid(request=None)

            order3 = Order.objects.create(user=user4, payment_method="cash", open=None)
            order3.orderproductrelation_set.create(product=product0, quantity=1)
            order3.orderproductrelation_set.create(product=ticket2, quantity=1)
            order3.orderproductrelation_set.create(product=tent1, quantity=1)
...
programming for a danish startup.
            ...
            TeamTask.objects.create(
                team=bar_team, name="Taps", description="Taps must be ordered"
            )
            TeamTask.objects.create(
                team=bar_team,
                name="Coffee",
            ...
            TeamMember.objects.create(
                team=noc_team, user=user4, approved=True, responsible=True
            )
            TeamMember.objects.create(team=noc_team, user=user1, approved=True)
            TeamMember.objects.create(team=noc_team, user=user5, approved=True)
            TeamMember.objects.create(team=noc_team, user=user6)

            # bar team
            TeamMember.objects.create(
                team=bar_team, user=user1, approved=True, responsible=True
            )
            TeamMember.objects.create(
                team=bar_team, user=user3, approved=True, responsible=True
            )
            TeamMember.objects.create(team=bar_team, user=user2, approved=True)
            TeamMember.objects.create(team=bar_team, user=user7, approved=True)
            TeamMember.objects.create(team=bar_team, user=user8)

            # orga team
            TeamMember.objects.create(
                team=orga_team, user=user1, approved=True, responsible=True
            )
            TeamMember.objects.create(
                team=orga_team, user=user3, approved=True, responsible=True
            )
            TeamMember.objects.create(team=orga_team, user=user8, approved=True)
            TeamMember.objects.create(team=orga_team, user=user9, approved=True)
            TeamMember.objects.create(team=orga_team, user=user4)

            self.output("Creating infocategories for {}...".format(year))
            info_cat1 = InfoCategory.objects.create(
                team=orga_team, headline="When is BornHack happening?", anchor="when"
            )
            info_cat2 = InfoCategory.objects.create(
                team=orga_team, headline="Travel Information", anchor="travel"
            )
            info_cat3 = InfoCategory.objects.create(
                team=orga_team, headline="Where do I sleep?", anchor="sleep"
            )
